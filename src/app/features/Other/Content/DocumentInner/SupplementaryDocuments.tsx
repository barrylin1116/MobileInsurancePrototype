...
const SupplementaryDocuments: React.FC<any> = (props) => {
  ...
  return (
    <div id="SupplementaryDocuments">
      <div className="row m-0 p-2" style={{ background: '#DDFDE7' }}>
          ...
          >
            ...
            <Upload {...uploadProps} showUploadList={false}>
              <Button
                ...
                icon={<UploadOutlined />}
                style={{ borderRadius: '0 4px 4px 0', backgroundColor: '#E07F0A', color: '#fff', height: '50px' }}
              >
                請選擇檔案
              </Button>
            </Upload>
      ...
      </div>
      {
        fileUploadSuccessList.length > 0 && (
          <>
            <div className="row m-0" style={{ background: '#DDFDE7' }}>
