...
const HealthDeclarationForm = React.forwardRef<any, any>((props, ref) => {
    ...
    return (
      diseaseQuestionnaireList.map((data, index) => {
        return (
          index % 2 === 0 && (
            <div
              style={{ border: '1px solid #9a0036', borderTop: 'none' }}
  ...
  return (
    <>
      <div className="row m-0 p-4" style={{ border: '1px solid #9a0036' }}>
        <div className="col-6">
              ...
              checkboxesState.filter(data => data).length > 0 && (
                <>
                  <div
                    ...
                    style={{ border: '1px solid #9a0036', background: '#FDE6EE', borderTop: 'none' }}
                  >
                    <div className="col-12">
