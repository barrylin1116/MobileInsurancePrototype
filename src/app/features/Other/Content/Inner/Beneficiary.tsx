                ...
                <div className="grey2 box">
                  ...
                  <div className="row form-row relation-row">
                    <div className="col-12">
                      ...
                      <input type="text" name="swiftCode" className="form-control" placeholder="臺幣保單不需輸入" />
                    </div>
                    <div className="col-12">
            ...
            <div className="row form-row">
              <div id="applicant-beneficiary-list" className="beneficiary-list col-12 mb-2">
                ...
                <div className="box mb-2">
                  <div className="head">
                    <div className="labelName">身故受益人（一）</div>
                    ...
                    <div className="row form-row relation-row">
                      <div className="col-6">
                        <div className="d-flex justify-between">
                          ...
                          <div className="d-flex align-items-center">
                            <button type="button" className="btn btn-primary btn-sm width-100-pct">同要保人住宅電話
                            </button>
                          </div>
                        </div>
                      ...
                      <div className="col-6">
                        <div className="d-flex justify-between">
                          ...
                          <div className="d-flex align-items-center">
                            <button type="button" className="btn btn-primary btn-sm width-100-pct">同要保人手機號碼
                            </button>
                          </div>
                        </div>
                        <div className="phone-inputs" style={{ margin: '4px 0' }}>
