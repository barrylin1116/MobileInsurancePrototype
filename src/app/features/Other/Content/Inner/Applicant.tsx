    ...
    <div>
      ...
      <div className="row m-0">
        ...
        <div className="col-5">
          ...
          <div className="d-flex">
            <input
              type="radio" name="declare" value="N" className="form-check-input me-2 mb-1" onChange={(e) => {
                setDeclare(e.target.value);
              }}
            />
            <label className="form-check-label me-2 text-nowrap labelName">否</label>
            <input
              type="radio" name="declare" value="Y" className="form-check-input me-2 mb-1" onChange={(e) => {
                setDeclare(e.target.value);
              }}
            />
