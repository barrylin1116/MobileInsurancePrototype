...
const InsuredAddress02: React.FC = () => {
  return (
    <>
        ...
        <div className="col py-2">
          <div className="row flex-column flex-md-row justify-content-md-between">
            <div className="col d-flex align-items-center">
              <div className="form-label labelName m-0">通訊地址</div>
            </div>
            <div className="col col-md-auto d-flex align-items-center">
              <button className="btn btn-custom btn-elife-green mx-2">同被保人住所</button>
              <button className="btn btn-custom btn-elife-green mx-2">同要保人住所</button>
            </div>
          </div>
        </div>
        <div className="col py-2">
          <div className="row flex-column flex-xl-row">
            <div className="col col-xl-4 my-2 my-xl-0">
              <div className="row">
                <div className="col">
                  <select
                    id="applicant-cityId" name="applicant.cityId" className="form-select"
                    data-field-invalid="true" placeholder="縣市"
                  >
                    <option className="bs-title-option" value="" />
                ...
                <div className="col">
                  <select
                    id="applicant-areaId" name="applicant.areaId" className="form-select"
                    data-field-invalid="true" placeholder="區域"
                  >
                    <option className="bs-title-option" value="" />
                  </select>
            ...
            <div className="col col-xl-8 my-2 my-xl-0">
              <div className="row">
                ...
                <div className="col-10 col-xl-10">
                  <select
                    id="applicant-addr01" name="applicant.addr01" className="form-select"
                    data-field-invalid="true" placeholder="請選擇路名"
                  >
                    <option className="bs-title-option" value="" />
                  </select>
          ...
          <div className="row flex-column flex-xl-row">
                  ...
                  <div className="row flex-column flex-md-row">
                    <div className="col d-flex align-items-center">
                      <div className="input-group">
                        ...
                        />
                        <div className="col-form-label labelName p-2">巷</div>
                      </div>
                    </div>
                    <div className="col d-flex align-items-center">
                      <div className="input-group">
                        <input
                          type="text" id="applicant-postCode" className="form-control"
                        />
                        <div className="col-form-label labelName p-2">弄</div>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="col d-flex align-items-center">
                      <div className="input-group">
                        <input
                          type="text" id="applicant-postCode" className="form-control"
                        />
                        <div className="col-form-label labelName p-2">之</div>
                      </div>
                    </div>
                    <div className="col d-flex align-items-center">
                      <div className="input-group">
                        <input
                          type="text" id="applicant-postCode" className="form-control"
                        />
                        <div className="col-form-label labelName p-2">號</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col">
              <div className="input-group">
                ...
                />
                <div className="input-group-text border-0 bg-transparent" id="basic-addon1">樓之</div>
                <input
                  type="text" className="form-control"
                />
...
export default InsuredAddress02;
