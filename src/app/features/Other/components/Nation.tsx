...
const Nation: React.FC = () => {
  return (
    <>
      <div className="form-label labelName">國籍</div>
      <div className="row">
        <div className="col col-lg-auto d-flex align-items-center elife-col-height ">
          <div className="form-check d-flex align-items-center">
            ...
            />
            <label className="form-check-label labelName m-0 ms-2" htmlFor="applicantNationType-0">中華民國</label>
          </div>
        </div>
        <div className="col col-lg-5 d-flex align-items-center elife-col-height ">
          <div className="d-flex align-items-center text-nowrap">
            <div className="form-check d-flex align-items-center pe-2">
              <input
                ...
                className="form-check-input" data-field-invalid="false" aria-label="Foreign" value="Foreign"
              />
              <label className="form-check-label labelName m-0 ms-2" htmlFor="applicantNationType-1">其他</label>
            </div>
            <select
              id="applicant-nationalityId" name="applicant.nationalityId" className="form-select"
              placeholder="請選擇"
            >
