...
const InsuredAddress01: React.FC = () => {
  return (
    <>
        ...
        <div className="col py-2">
          <div className="row justify-content-between">
            <div className="col d-flex align-items-center">
              <div className="form-label labelName m-0">住所地址</div>
            </div>
            <div className="col col-md-auto d-flex align-items-center">
              <button className="btn btn-custom btn-elife-green">同被保人住所</button>
            </div>
          </div>
        </div>
        <div className="col py-2">
...
export default InsuredAddress01;
