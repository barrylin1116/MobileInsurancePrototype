...
//             name="applicant.allocateBy01" id="applicant-allocateBy-0"
//             value="prec"
//             checked
//           />
...
//           <input
//             type="radio" className="form-check-input me-2 mb-1"
//             name="applicant.allocateBy01" id="applicant-allocateBy-1"
//             value="prop"
//           />
...
// };
//
// export default React.memo(Allocate);

import React from 'react';

const Allocate: React.FC = () => {
  return (
    <div id="Allocate01" className="row">
      <div className="col">
