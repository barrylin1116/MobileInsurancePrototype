...
const ContentModal: React.FC<ModalProps> = (props) => {
          ...
          <div className="modal-content">
            <div className="modal-header">
              <div className="row contentRow">
                <div>
                  <button onClick={handleClose} type="button" className="btn-close" data-bs-dismiss="modal" aria-label="close" value="取消" />
                  <span onClick={handleClose} className="btn-close-text">{props.backTitle ? props.backTitle : '取消'}</span>
                  {props.title && (
